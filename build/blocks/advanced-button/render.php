...
$axiom_blocks_icons    = include __DIR__ . '/icons.php';
$axiom_blocks_icon_svg = ( '' !== $axiom_blocks_icon && isset( $axiom_blocks_icons[ $axiom_blocks_icon ] ) )
	? $axiom_blocks_icons[ $axiom_blocks_icon ]
	: '';
...
<button type="submit" <?php echo '' !== $axiom_blocks_id_attr ? 'id="' . esc_attr( $axiom_blocks_id_attr ) . '" ' : ''; ?>class="<?php echo esc_attr( $axiom_blocks_class_attr ); ?>"<?php echo '' !== $axiom_blocks_style_attr ? ' style="' . esc_attr( $axiom_blocks_style_attr ) . '"' : ''; ?><?php echo '' !== $axiom_blocks_aria_label ? ' aria-label="' . esc_attr( $axiom_blocks_aria_label ) . '"' : ''; ?>>
<?php else : ?>
<a href="<?php echo esc_url( $axiom_blocks_href ); ?>"<?php echo $axiom_blocks_new_tab ? ' target="_blank"' : ''; ?><?php echo '' !== $axiom_blocks_rel ? ' rel="' . esc_attr( $axiom_blocks_rel ) . '"' : ''; ?><?php echo $axiom_blocks_is_download ? ' download' : ''; ?> <?php echo '' !== $axiom_blocks_id_attr ? 'id="' . esc_attr( $axiom_blocks_id_attr ) . '" ' : ''; ?>class="<?php echo esc_attr( $axiom_blocks_class_attr ); ?>"<?php echo '' !== $axiom_blocks_style_attr ? ' style="' . esc_attr( $axiom_blocks_style_attr ) . '"' : ''; ?><?php echo '' !== $axiom_blocks_aria_label ? ' aria-label="' . esc_attr( $axiom_blocks_aria_label ) . '"' : ''; ?>>
<?php endif; ?>
